...
"""q_url is a tag to append, remove or replace query string parameters from an url (preserve order)"""
...
class QURLNode(Node):
    """Implements the actions of the q_url tag."""
    ...
    def render(self, context):
        ...
        qp = parse_qsl(urlp[4].encode('utf-8'))
